...
function main()
  ...
  function get_reference_dir(μ)
    return "results/LFR_single_graph_groups/N_micro=$(N_micro),N_mfl=$(N_mfl)/reference/μ=$μ"
  end
  ...
  function f(tuple)
    ...
    prefix = "LFR_single_graph_groups/N_micro=$(N_micro),N_mfl=$(N_mfl)/σ²=$(β_σ²)/μ=$μ"
  ...
  prefix = "results/LFR_single_graph_groups/N_micro=$(N_micro),N_mfl=$(N_mfl)/σ²=$(β_σ²)/μ=$μ"
